...
# input ------
fas_ha_g <- "data/in/pH5_G_2136_20171124.fasta" 
fas_na_g <- "data/in/pNA_G_2135_20171124.fasta"
csv_g    <- "data/in/G_2135_20171124.csv"

fas_ha_n <- "data/in/pH5_N_5753_20171124.fasta" 
fas_na_n <- "data/in/pNA_N_5721_20171124.fasta"
...
# export ------
write.csv( file = "data/out/pH5NA.csv", x =
...
write.fasta( sequences = paired_infolist_na[[6]], 
             ...
             ), file.out  = paste0( "data/out/pNA_", length( paired_infolist_na[[1]] ) ,".fasta") )
...
write.fasta( sequences = c_infolist.ha[[6]], 
             names     = paste0( c_infolist.ha[[1]], "_",
                                 ...
                                 c_infolist.ha[[2]], "_",
                                 c_infolist.ha[[4]]
             ), file.out  = paste0( "data/out/pH5_", length( c_infolist.ha[[1]] ) ,".fasta")  )


# extract N1 
rmDup( fasfile = "data/out/pNA_7138.fasta", sero = "H5N1", rmdup = FALSE)
