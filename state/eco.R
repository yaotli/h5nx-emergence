...
pH5_pri_cn_234      <- taxaInfo( "./gsgd/out//pH5_c234_2429.fasta" )
...
write.csv( pH5_pri_cn_234[[8]], "./state/out//eco_234.csv")



## c232 Eco ----------------

pH5_pri_cn_232      <- taxaInfo( "./gsgd/out//pH5_c232_1296.fasta" )
...
write.csv( pH5_pri_cn_232[[8]], "./state/out/eco_232.csv")



## c7 Eco ----------------

pH5_pri_cn_7      <- taxaInfo( "./clade7/out/pH5_c7_80.fasta" )
...
write.csv( pH5_pri_cn_7[[8]], "./state/out/eco_7.csv")